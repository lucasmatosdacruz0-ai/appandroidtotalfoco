        ...
        <div className="bg-gray-800 rounded-xl shadow-lg transition-all duration-300">
            <div className="w-full p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex-1 w-full">
                    ...
                    >
                        <h3 className="text-xl font-bold text-gray-100 group-hover:text-blue-400 transition-colors">{progress.name}</h3>
                        <VideoIcon className="w-5 h-5 text-blue-500 shrink-0 group-hover:text-blue-400 transition-colors"/>
                    </button>

                    <div className="flex items-center flex-wrap gap-x-4 gap-y-1 text-sm mt-1 text-gray-400">
                        {isSingleWorkout ? (
                            <span className="font-bold text-gray-400">Ponto de partida</span>
                        ) : (
                            <span>
                ...
                <div className="flex items-center gap-4 w-full sm:w-auto justify-end">
                    ...
                    <button 
                        ...
                        className="flex items-center justify-center gap-2 bg-gray-700 text-gray-300 font-semibold py-2 px-3 rounded-lg hover:bg-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
            ...
            {isExpanded && !isSingleWorkout && (
                <div className="p-4 border-t border-gray-700 animate-fade-in">
                    <h4 className="font-semibold text-gray-300 mb-2">Evolução da Carga Máxima (kg)</h4>
