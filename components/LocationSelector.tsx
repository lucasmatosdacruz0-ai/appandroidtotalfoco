...
const LocationSelector: React.FC<LocationSelectorProps> = ({ onSelect, currentLocation }) => {
  return (
    <div className="text-center">
      <h2 className="text-2xl sm:text-3xl font-bold text-gray-100">Onde você vai treinar hoje?</h2>
      <p className="text-gray-400 mt-2 mb-8">Vamos adaptar os exercícios para o seu ambiente.</p>
        ...
        {locations.map(({ location, icon, description }) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-200 mt-2">{location}</h3>
